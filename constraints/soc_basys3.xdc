# CMPE 140 Lab 8: Basys-3 Constraints for SoC Implementation
...
# Timing constraints
set_input_delay -clock sys_clk_pin -min 0.000 [all_inputs]
set_input_delay -clock sys_clk_pin -max 2.000 [all_inputs]
set_output_delay -clock sys_clk_pin -min 0.000 [all_outputs]
set_output_delay -clock sys_clk_pin -max 2.000 [all_outputs]